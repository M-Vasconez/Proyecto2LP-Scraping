...
plt.savefig('resultados/precio promedio')
...
plt.savefig('resultados/pulgadas')
#PROCESADORES
...
plt.savefig('resultados/procesadores')
...
headgb.to_csv('resultados/gama baja.csv')
#GAMA MEDIA BAJA
...
headgmb.to_csv('resultados/gama media baja.csv')
#GAMA MEDIA
...
headm.to_csv('resultados/gama media.csv')
#GAMA MEDIA ALTA
...
headma.to_csv('resultados/gama media alta.csv')
#GAMA ALTA
...
headga.to_csv('resultados/gama alta.csv')